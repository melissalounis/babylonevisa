...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['action']) && isset($_POST['id'])) {
            ...
            switch($action) {
                case 'changer_statut':
                    if (isset($_POST['statut'])) {
                        $statut = $_POST['statut'];
                        $stmt = $pdo->prepare("UPDATE demandes_paris_saclay SET statut = ?, date_modification = NOW() WHERE id = ?");
                ...
                case 'supprimer':
                    ...
                    $stmt = $pdo->prepare("SELECT chemin_fichier FROM demandes_paris_saclay_fichiers WHERE demande_id = ?");
                    $stmt->execute([$id]);
                    ...
                    $stmt = $pdo->prepare("DELETE FROM demandes_paris_saclay_fichiers WHERE demande_id = ?");
                    $stmt->execute([$id]);
                    
                    // Supprimer la demande
                    $stmt = $pdo->prepare("DELETE FROM demandes_paris_saclay WHERE id = ?");
                    $stmt->execute([$id]);
        ...
        header('Location: universites_demandes.php');
        exit();
    }
}
...
try {
    ...
    $stmt = $pdo->query("DESCRIBE demandes_paris_saclay");
    ...
    $count_sql = "SELECT COUNT(*) FROM demandes_paris_saclay $where_sql";
    ...
    $sql = "SELECT * FROM demandes_paris_saclay $where_sql ORDER BY $date_column DESC LIMIT $limit OFFSET $offset";
...
<head>
    ...
    <title>Administration Paris-Saclay - Babylone Service</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <style>
        :root {
            --saclay-blue: #0055a4;
            --saclay-orange: #ff6b35;
            --saclay-white: #FFFFFF;
            --saclay-light-blue: #e8f2ff;
            --light-gray: #f8f9fa;
        }
        ...
        .sidebar {
            background: linear-gradient(135deg, var(--saclay-blue), #003366);
            color: white;
            min-height: 100vh;
            position: fixed;
            width: 250px;
        ...
        .saclay-banner {
            background: linear-gradient(90deg, var(--saclay-blue) 0%, var(--saclay-blue) 50%, var(--saclay-orange) 50%, var(--saclay-orange) 100%);
            height: 4px;
            margin-bottom: 10px;
            border-radius: 2px;
        }
...
<body>
    <div class="wrapper">
        ...
        <nav class="sidebar">
            ...
            <ul class="nav flex-column p-3">
                ...
                <li class="nav-item mb-2">
                    <a href="universites_demandes.php" class="nav-link text-white bg-dark rounded">
                        <i class="fas fa-graduation-cap me-2"></i>
                        Paris-Saclay
                    </a>
                </li>
        ...
        <div class="main-content">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <div class="saclay-banner"></div>
                    <h1 class="h3 mb-1">
                        <i class="fas fa-university text-primary me-2"></i>
                        Gestion des Demandes Paris-Saclay
                    </h1>
                    <p class="text-muted mb-0">Consultez et gérez toutes les demandes Université Paris-Saclay</p>
                </div>
            ...
            <div class="filter-section bg-white rounded p-3 mb-4">
                <form method="GET" class="row g-3 align-items-end">
                    ...
                    <div class="col-md-3">
                        <a href="universites_demandes.php" class="btn btn-outline-secondary w-100">
                            ...
                            <?php if (empty($demandes)): ?>
                                <tr>
                                    <td colspan="9" class="text-center py-5">
                                        ...
                                        <p class="text-muted">Aucune demande Paris-Saclay trouvée</p>
                            ...
                            <?php else: ?>
                                <?php foreach($demandes as $demande): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo getDateSoumission($demande, $date_column); ?>
                                        </td>
                                        <td>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title">Détails de la demande Paris-Saclay</h5>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form method="POST" action="universites_demandes.php" id="form-delete-user">
    ...
    <script>
        function afficherDetails(demandeId) {
            ...
            fetch(`details_paris_saclay.php?id=${demandeId}`)
                .then(response => {
                    if (!response.ok) {
        ...
        function genererContenuDetails(demande) {
            ...
            function getFileIcon(typeFichier) {
                const icons = {
                    'copie_piece_identite': 'fas fa-id-card text-primary',
                    ...
                    'piece_identite_garant': 'fas fa-id-badge text-danger',
            ...
            function getFileTypeLabel(typeFichier) {
                const labels = {
                    'copie_piece_identite': 'Copie pièce identité',
                    ...
                    'piece_identite_garant': 'Pièce identité garant',
                    'default': 'Document'
                };
            ...
            return `
                <div class="details-container">
                    ...
                    <div class="row mb-4">
                        <div class="col-12">
                            <div class="d-flex justify-content-between align-items-center">
                                <h4 class="mb-0">Demande Paris-Saclay #${demande.id}</h4>
                                <span class="badge bg-${demande.statut_class} fs-6">
                                    ${demande.statut_formatted}
                                </span>
                            </div>
                            <p class="text-muted mb-0">Référence: PS-${demande.id.toString().padStart(6, '0')} | ID Utilisateur: ${demande.user_id}</p>
                        </div>
                    </div>
                                ...
                                <div class="card-body">
                                    <table class="table table-sm table-borderless">
                                        <tr>
                                            ...
                                            <td>${demande.type_piece_identite}</td>
                                        </tr>
                                        <tr>
                                            <td><strong>Numéro:</strong></td>
                                            <td>${demande.num_piece_identite}</td>
                                        </tr>
                                        <tr>
                                            <td><strong>Délivrance:</strong></td>
                                            <td>${formatDate(demande.date_delivrance_piece)}</td>
                                        </tr>
                                        <tr>
                                            <td><strong>Expiration:</strong></td>
                                            <td>${formatDate(demande.date_expiration_piece)}</td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
        ...
        function changerStatut(id, nouveauStatut) {
            if (confirm('Êtes-vous sûr de vouloir changer le statut de cette demande ?')) {
                ...
                form.method = 'POST';
                form.action = 'universites_demandes.php';
        ...
        document.addEventListener('DOMContentLoaded', function() {
            console.log('Administration Paris-Saclay chargée');
        });
    </script>
</body>
</html>