  ...
  <div class="services-grid">
    ...
    <div class="service-card italie-card">
      ...
      <div class="card-content">
        ...
        <div class="card-actions">
          <a class="service-btn italie-btn" href="/babylone/public/italie/etudes/index.php">
    ...
    <div class="service-card italie-card">
      ...
      <div class="card-image">
        <img src="../../images/bourse.jpg" alt="Demande de bourse Italie">
        <div class="card-overlay"></div>
        <div class="card-flag"></div>
      </div>
      <div class="card-content">
        <h3>Demande de Bourse</h3>
        <p>Financez vos études en Italie grâce aux bourses disponibles</p>
        <ul class="service-features">
          <li><i class="fas fa-check-circle"></i> Recherche de bourses</li>
          <li><i class="fas fa-check-circle"></i> Préparation du dossier</li>
          <li><i class="fas fa-check-circle"></i> Lettres de motivation</li>
          <li><i class="fas fa-check-circle"></i> Suivi des candidatures</li>
        </ul>
        <div class="card-actions">
          <a class="service-btn italie-btn" href="/babylone/public/italie/bourse/index.php">
            <span>Demander une bourse</span>
            <i class="fas fa-arrow-right"></i>
          </a>
          <a class="service-link" href="#contact">Plus d'informations</a>
        </div>
...
<style>
  :root {
    ...
    --shadow-italie: 0 10px 30px rgba(0, 140, 69, 0.2);
    --shadow-italie-hover: 0 20px 50px rgba(0, 140, 69, 0.3);
  }
  ...
  * {
  ...
  .card-overlay {
    ...
    width: 100%;
    height: 100%;
    background: linear-gradient(to bottom, transparent 0%, rgba(0, 140, 69, 0.8) 100%);
    transition: all 0.3s ease;
  }
  ...
  .italie-btn:hover {
    ...
    box-shadow: 0 10px 25px rgba(0, 140, 69, 0.4);
  }
  ...
  .italie-info {
    ...
    border-left: 4px solid var(--italie-green);
    border-radius: 12px;
    padding: 25px;
    display: flex;
