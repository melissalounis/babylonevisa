...
<style>
    ...
    .pays-hero {
        ...
        text-align: center;
        overflow: hidden;
        background:url('images/famile2.jpg');
        margin-top: -40px;
    }
...
<section class="info-section">
    <div class="info-content">
        <h2>Vous ne trouvez pas votre destination ?</h2>
        <p>Notre réseau international s'étend bien au-delà de ces pays. Contactez-nous pour discuter de votre projet, même si votre destination ne figure pas dans cette liste.</p>
        <a href="contact.php" class="hero-btn">Nous contacter</a>
    </div>
</section>
