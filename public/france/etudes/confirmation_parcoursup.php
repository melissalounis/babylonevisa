...
<head>
    ...
    <title>Confirmation - Parcoursup</title>
...
<body>
    <div class="container">
        <div class="confirmation-container text-center">
            ...
            <h2 class="confirmation-header">Candidature soumise avec succès !</h2>
            <p class="lead">Votre candidature Parcoursup a été enregistrée.</p>
            ...
            <div class="my-4">
                ...
                ?>
                <p><strong>Prochaine étape :</strong> Votre candidature va être examinée par les établissements. Vous recevrez les réponses à partir du 1er juin.</p>
            </div>

            <a href="../../index.php" class="btn btn-success mt-3">Retour à l'accueil</a>
            <a href="mes-candidatures.php" class="btn btn-outline-success mt-3">Consulter mes candidatures</a>
        </div>
    </div>
</body>
</html>